...
export const TOKEN_SWAP_PROGRAM_ID: PublicKey = new PublicKey(
  '4sB4ruJ6be2b7BNNnmwHynSgqkRdyP56bKbkGRmMjCSM',
);
...
export const TokenSwapLayout = BufferLayout.struct(
  [
    ...
    Layout.publicKey('ammId'),
    Layout.publicKey('dexProgramId'),
...
export class TokenSwap {
  ...
  static createInitSwapInstruction(
    ...
    const ammId = PublicKey.findProgramAddress(tokenProgramId, [tokenProgramId])
    const dexProgramId = PublicKey.findProgramAddress(tokenProgramId, [tokenProgramId])
    const marketId = PublicKey.findProgramAddress(tokenProgramId, [tokenProgramId])
    const keys = [
